...
$query = "INSERT INTO t_pembayaran_spp (
              id_wali, id_siswa, tgl_bayar, kelas, semester, jumlah_bayar, kwitansi, catatan, status_validasi
          ) VALUES (
              '$id_wali', '$id_siswa', '$tgl_bayar', '$kelas', '$semester', '$jumlah_bayar', '$new_file_name', '$catatan', 'Pending'
          )";
