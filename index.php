...
<head>
    ...
    <title>Login - Sistem Peembayaran SPP MI Al-Huda</title>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <!-- <div class="auth-logo">
                        <a href="#"><img src="./assets/compiled/svg/mi.png" alt="Logo"></a>
                    </div> -->
                    <h1 class="auth-title">Login</h1>
                    <p class="auth-subtitle mb-5">Sistem Pembayaran <br> SPP MI Al-Huda</p>
